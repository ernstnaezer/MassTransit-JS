...
(function(exports){
	...
	var Emitter =  (typeof window === 'undefined') ? require('./inc/eventemitter').EventEmitter: window.EventEmitter;
	var Log 	= (typeof masstransit === 'undefined') ? require('./inc/log').Log: masstransit.Log;
